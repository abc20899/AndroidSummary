...
import kotlinx.android.synthetic.main.activity_server_main.*
...
class MainActivity : AppCompatActivity(), EasyPermissions.PermissionCallbacks {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        requestPermission()
        NIOHttpServer.instance.startServer()
        setContentView(R.layout.activity_server_main)
        showIp.text = "请在浏览器打开http://${NIOHttpServer.instance.wifiIp}:5000"
    }
...
//        getImageFolders()
    ...
    override fun onDestroy() {
        super.onDestroy()
        NIOHttpServer.instance.stopServer()
    }
}