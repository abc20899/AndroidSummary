...
public class GridPasswordView extends LinearLayout implements PasswordView {
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mLineWidth = (int) ta.getDimension(R.styleable.gridPasswordView_gpvLineWidth,
        ...
        mPasswordLength = ta.getInt(R.styleable.gridPasswordView_gpvPasswordLength,
                DEFAULT_PASSWORDLENGTH);
        mPasswordTransformation = ta
                .getString(R.styleable.gridPasswordView_gpvPasswordTransformation);
    ...
    private void inflaterViews(Context context) {
        ...
        inflater.inflate(R.layout.gridpassw_view, this);
        ...
        while (index < mPasswordLength) {
            View dividerView = inflater.inflate(R.layout.gridpassw_divider, null);
            ...
            TextView textView = (TextView) inflater.inflate(R.layout.gridpassw_textview, null);
    ...
    private ImeDelBugFixedEditText.OnDelKeyEventListener onDelKeyEventListener = new
            ImeDelBugFixedEditText.OnDelKeyEventListener() {
                @Override
