 ...
 * 定义一个ViewGroup，内部可以传入0到4个childView，分别依次显示在左上角，右上角，左下角，右下角。
 */
public class CustomContainer extends ViewGroup {
    ...
    // 重写父类的该方法，返回MarginLayoutParams的实例，这样就为我们的ViewGroup指定了其LayoutParams
    // 为MarginLayoutParams。
    @Override
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        // 所以我们自己需要计算如果设置为wrap_content时的宽和高，如何计算呢？
        // 那就是通过其childView的宽和高来进行计算。
